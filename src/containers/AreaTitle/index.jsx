...
const AreaTitle = (props) => {
    ...
    return (
        <aside class='h-full w-fit flex flex-col justify-center items-center p-6 gap-2 rounded-md bg-gray-100/25 border-2 border-black ml-11 sm:m-0 sm:p-1 sm:h-48 sm:gap-0 sm:w-1/2 wide:gap-0 wide:p-1 wide:m-0 wide:h-36 wide:w-52'>
            <LocationsButton
