...
const ForecastSquare = (props) => {
    ...
    return (
        <div class='flex flex-col'>
            ...
            />
            <p class='m-0 p-0 text-xs'>Feels Like: <b>{forecastInfo[2]}&deg;</b></p>
            <p class='m-0 p-0 text-xs'>Precip: <b>{forecastInfo[7]}%</b></p>
            <p class='m-0 p-0 text-xs'>Precip Amt: <b>{forecastInfo[5]}</b></p>
            <p class='m-0 p-0 text-xs'>Sunrise:  <b>{forecastInfo[3]}</b></p>
            <p class='m-0 p-0 text-xs'>Sunset:  <b>{forecastInfo[4]}</b></p>
        </div>
    )
}
